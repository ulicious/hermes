...
from methods_algorithm import postprocessing_solutions, create_solutions_based_on_commodities_at_start,\
    check_for_inaccessibility_and_at_destination, adjust_production_costs_of_commodities
from script_benchmark import calculate_benchmark
from _helpers import get_continent_from_location, calculate_minimal_costs_conversion_for_oil_and_gas_infrastructure
...
def run_algorithm(args):
    ...
    while not solutions.empty:  # while loop runs as long as solutions to process exist
        ...
        if configuration['allow_first_iteration_conversion'] | (iteration > 0):
            ...
            solutions, potential_final_solution, solution_number, benchmark, local_benchmarks = \
                apply_conversion(solutions, configuration, data, solution_number,
                                 benchmark, local_benchmarks, iteration)
