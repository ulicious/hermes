...
def remove_short_edges(graphs, line_data, nodes):
    ...
    while True:
        ...
        for g in graphs['graph'].unique():
            ...
            edges_of_affected_nodes = g_graphs[
                (g_graphs['node_start'].isin(affected_nodes)) | (g_graphs['node_end'].isin(affected_nodes))]
...
def concentrate_nodes(graphs, line_data, nodes, number_workers):
    ...
    while True:
        ...
        def process_node(input_local):
            ...
            if n_local in filtered_nodes_local: # todo: kann entfernt werden weil n_local gar nicht erst angesteuert werden würde
                return None
